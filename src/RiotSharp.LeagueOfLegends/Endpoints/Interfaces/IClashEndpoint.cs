...
namespace RiotSharp.LeagueOfLegends.Endpoints.Interfaces
{
    ...
    public interface IClashEndpoint
    {
        ...
        /// <param name="puuid">Puuid for which you need to retrieve clash player list</param>
        /// <returns>A List of currently active clash players</returns>
        Task<List<ClashPlayer>?> GetClashPlayersByPuuidAsync(Region region, string puuid);
