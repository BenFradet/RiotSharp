...
{
	internal class TournamentMapTypeConverter : JsonConverter<TournamentMapType>
	{
		public override TournamentMapType Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
		{
		...
		public override void Write(Utf8JsonWriter writer, TournamentMapType value, JsonSerializerOptions options)
		{
