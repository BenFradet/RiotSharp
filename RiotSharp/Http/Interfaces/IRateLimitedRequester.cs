...
namespace RiotSharp.Http.Interfaces
{
    interface IRateLimitedRequester
    {
        ...
        /// <summary>
        /// Create a get request and send synchronously it to the server.
        /// </summary>
        ...
        /// <summary>
        ///  Create a get request and send asynchronously it to the server.
        /// </summary>
        /// <param name="relativeUrl"></param>
        /// <param name="region"></param>
        /// <param name="addedArguments"></param>
        ...
        /// <summary>
        /// Create a post request and send synchronously it to the server.
        /// </summary>
        /// <param name="relativeUrl"></param>
        /// <param name="region"></param>
        ...
        /// <summary>
        /// Create a post request and send asynchronously it to the server.
        /// </summary>
        /// <param name="relativeUrl"></param>
        /// <param name="region"></param>
        /// <param name="body"></param>
        ...
        /// <summary>
        /// Create a put request and send synchronously it to the server.
        /// </summary>
        /// <param name="relativeUrl"></param>
        /// <param name="region"></param>
        /// <param name="body"></param>
