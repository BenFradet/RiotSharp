...
namespace RiotSharp.LeagueOfLegends.Endpoints.ChallengesEndpoint.Models
{
    ...
    public class ChallengeConfigInfo
    {
        ...
        public required Dictionary<Language, ChallengeDescription> LocalizedNames { get; set; }
        ...
        public required bool Leaderboard { get; set; }
        ...
        public required Dictionary<Level, double> Thresholds { get; set; }
    }
}