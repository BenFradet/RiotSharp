...
using RiotSharpNET8.Endpoints.ClashEndpoint.Models;
using RiotSharpNET8.Endpoints.Interfaces;
using RiotSharpNET8.Http.Interfaces;
using RiotSharpNET8.Misc;

namespace RiotSharpNET8.Endpoints.ClashEndpoint
{
    /// <summary>
    /// The Clash Endpoint
    /// </summary>
    public class ClashEndpoint : IClashEndpoint
    {
        ...
        public async Task<List<ClashPlayer>> GetClashPlayersBySummonerIdAsync(Region region, string summonerId)
        {
            ...
            var clashPlayers = JsonSerializer.Deserialize<List<ClashPlayer>>(json);
        ...
        public async Task<ClashTeam> GetClashTeamByTeamIdAsync(Region region, string teamId)
        {
            ...
            var clashTeam = JsonSerializer.Deserialize<ClashTeam>(json); //JsonConvert.DeserializeObject<ClashTeam>(json);
        ...
        public async Task<List<ClashTournament>> GetClashTournamentListAsync(Region region)
        {
            ...
            var tournaments = JsonSerializer.Deserialize<List<ClashTournament>>(json); //JsonConvert.DeserializeObject<List<ClashTournament>>(json);
        ...
        public async Task<ClashTournament> GetClashTournamentByTeamAsync(Region region, string teamId)
        {
            ...
            var tournament = JsonSerializer.Deserialize<ClashTournament>(json); //JsonConvert.DeserializeObject<ClashTournament>(json);
