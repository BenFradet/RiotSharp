...
{
	class WardTypeConverter : JsonConverter<WardType>
	{
		public override WardType Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
		{
		...
		public override void Write(Utf8JsonWriter writer, WardType value, JsonSerializerOptions options)
		{
