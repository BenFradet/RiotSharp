...
namespace RiotSharp
{
    ...
    public class RiotApi : IRiotApi
    {
        ...
        public Summoner GetSummoner(Region region, int summonerId)
        {
            ...
            var obj = JsonConvert.DeserializeObject<Dictionary<long, Summoner>>(json.Result).Values.FirstOrDefault();
            if (obj != null)
            {
                obj.Region = region;
            }
        ...
        public List<Summoner> GetSummoners(Region region, List<int> summonerIds)
        {
            var json = requester.CreateRequest(
                ...
                region);
            var list = JsonConvert.DeserializeObject<Dictionary<long, Summoner>>(json.Result).Values.ToList();
        ...
        public Summoner GetSummoner(Region region, string summonerName)
        {
            var json = requester.CreateRequest(
                ...
                region);
            var obj = JsonConvert.DeserializeObject<Dictionary<string, Summoner>>(json.Result).Values.FirstOrDefault();
            if (obj != null)
            {
                obj.Region = region;
            }
        ...
        public List<Summoner> GetSummoners(Region region, List<string> summonerNames)
        {
            var json = requester.CreateRequest(
                ...
                region);
            var list = JsonConvert.DeserializeObject<Dictionary<string, Summoner>>(json.Result).Values.ToList();
            foreach (var summ in list)
            {
                summ.Region = region;
            }
        ...
        public SummonerBase GetSummonerName(Region region, int summonerId)
        {
            ...
            var child = JsonConvert.DeserializeObject<Dictionary<string, string>>(json.Result);
        ...
        public List<SummonerBase> GetSummonersNames(Region region, List<int> summonerIds)
        {
            ...
            var children = JsonConvert.DeserializeObject<Dictionary<string, string>>(json.Result);
        ...
        public List<Champion> GetChampions(Region region, bool freeToPlay = false)
        {
            ...
            return JsonConvert.DeserializeObject<ChampionList>(json.Result).Champions;
        }
        ...
        public Champion GetChampion(Region region, int championId)
        {
            ...
            return JsonConvert.DeserializeObject<Champion>(json.Result);
        }
        ...
        public Dictionary<long, List<MasteryPage>> GetMasteryPages(Region region, List<int> summonerIds)
        {
            var json = requester.CreateRequest(
                ...
                region);
            return ConstructMasteryDict(JsonConvert.DeserializeObject<Dictionary<string, MasteryPages>>(json.Result));
        }
        ...
        public Dictionary<long, List<RunePage>> GetRunePages(Region region, List<int> summonerIds)
        {
            var json = requester.CreateRequest(
                ...
                region);
            return ConstructRuneDict(JsonConvert.DeserializeObject<Dictionary<string, RunePages>>(json.Result));
        }
        ...
        public Dictionary<long, List<League>> GetLeagues(Region region, List<int> summonerIds)
        {
            var json = requester.CreateRequest(
                ...
                region);
            return JsonConvert.DeserializeObject<Dictionary<long, List<League>>>(json.Result);
        }
        ...
        public Dictionary<string, List<League>> GetLeagues(Region region, List<string> teamIds)
        {
            var json = requester.CreateRequest(
                ...
                region);
            return JsonConvert.DeserializeObject<Dictionary<string, List<League>>>(json.Result);
        }
        ...
        public League GetChallengerLeague(Region region, Queue queue)
        {
            ...
            return JsonConvert.DeserializeObject<League>(json.Result);
        }
        ...
        public Dictionary<long, List<TeamEndpoint.Team>> GetTeams(Region region, List<int> summonerIds)
        {
            var json = requester.CreateRequest(
                ...
                region);
            return JsonConvert.DeserializeObject<Dictionary<long, List<TeamEndpoint.Team>>>(json.Result);
        }
        ...
        public Dictionary<string, TeamEndpoint.Team> GetTeams(Region region, List<string> teamIds)
        {
            var json = requester.CreateRequest(
                ...
                region);
            return JsonConvert.DeserializeObject<Dictionary<string, TeamEndpoint.Team>>(json.Result);
        }
        ...
        public MatchDetail GetMatch(Region region, long matchId, bool includeTimeline = false)
        {
            ...
            return JsonConvert.DeserializeObject<MatchDetail>(json.Result);
        }
            ...
            DateTime? beginTime = null, DateTime? endTime = null, int? beginIndex = null, int? endIndex = null)
        {
            ...
            var json = requester.CreateRequest(
                ...
                region,
                addedArguments);
            return JsonConvert.DeserializeObject<MatchList>(json.Result);
        }
        ...
        public List<PlayerStatsSummary> GetStatsSummaries(Region region, long summonerId)
        {
            var json = requester.CreateRequest(
                ...
                region);
            return JsonConvert.DeserializeObject<PlayerStatsSummaryList>(json.Result).PlayerStatSummaries;
        }
        ...
        public List<ChampionStats> GetStatsRanked(Region region, long summonerId)
        {
            var json = requester.CreateRequest(
                ...
                region);
            return JsonConvert.DeserializeObject<RankedStats>(json.Result).ChampionStats;
        }
        ...
        public List<Game> GetRecentGames(Region region, long summonerId)
        {
            var json = requester.CreateRequest(
                ...
                region);
            return JsonConvert.DeserializeObject<RecentGames>(json.Result).Games;
        }
        ...
        public CurrentGame GetCurrentGame(Platform platform, long summonerId)
        {
            ...
            return JsonConvert.DeserializeObject<CurrentGame>(json.Result);
        }
        ...
        public FeaturedGames GetFeaturedGames(Region region)
        {
            var json = requester.CreateRequest(
                ...
                region);
            return JsonConvert.DeserializeObject<FeaturedGames>(json.Result);
        }
