...
namespace RiotSharpTest
{
    public class TournamentRiotApiTestBase : CommonTestBase
    {
        ...
        public static TournamentSpectatorType tournamentSpectatorType = (TournamentSpectatorType)Enum.Parse(typeof(TournamentSpectatorType), 
            ConfigurationManager.AppSettings["TournamentSpectatorType"]);
        public static TournamentPickType tournamentPickType = (TournamentPickType)Enum.Parse(typeof(TournamentPickType), 
            ConfigurationManager.AppSettings["TournamentPickType"]);
        public static TournamentMapType tournamentMapType = (TournamentMapType)Enum.Parse(typeof(TournamentMapType), 
