...
namespace RiotSharpTest
{
    class RiotApiTestBase : CommonTestBase
    {
        ...
        public static Platform summoner1Platform = (Platform)Enum.Parse(typeof(Platform), ConfigurationManager.AppSettings["Summoner1Platform"]);
        ...
        public static Region summonersRegion = (Region)Enum.Parse(typeof(Region), ConfigurationManager.AppSettings["SummonersRegion"]);

        public static string queue = ConfigurationManager.AppSettings["Queue"];
        public static RiotSharp.MatchEndpoint.Enums.Season season = (RiotSharp.MatchEndpoint.Enums.Season)Enum.Parse(typeof(RiotSharp.MatchEndpoint.Enums.Season), ConfigurationManager.AppSettings["Season"]);
    }
}
