...
namespace RiotSharpNET8.Endpoints.MatchEndpoint
{
    ...
    public class MatchEndpoint : IMatchEndpoint
    {
        ...
        public async Task<Match> GetMatchAsync(Region region, string matchId)
        {
            ...
            var match = JsonSerializer.Deserialize<Match>(json); //JsonConvert.DeserializeObject<Match>(json);
        ...
        public async Task<MatchTimeline> GetMatchTimelineAsync(Region region, string matchId)
        {
            ...
            matchTimeline = JsonSerializer.Deserialize<MatchTimeline>(json); //JsonConvert.DeserializeObject<MatchTimeline>(json);
